// CSC 307 Fall 2018
// node1.h from https://www.cs.colorado.edu/~main/chapter5/node1.h
// with three added function prototypes for HW3, 
// to be implemented in node1hw3.cpp.
...
namespace main_savitch_5
{
	...
	/* head_ptr points to the head of "a single linked list of items".
	   After the function completes, headptr_to_less_than_nodes points to 
	   the head of the list "containing all the nodes that contain an item 
	   less than the splitting value", and headptr_to_all_other_nodes points to 
	   the head of the list "that contains all the other nodes." */
