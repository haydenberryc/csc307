// CSC 307 Fall 2018
// stack1.h from https://www.cs.colorado.edu/~main/chapter7/stack1.h
// with two added function prototypes for HW5, 
// to be implemented in stack1hw5.template.
...
namespace main_savitch_7A
{
    ...
    public:
		...
		// *** Function prototypes for HW5 *******
		// Chapter 7 Programming project 15
		void swap(stack<Item>& s);

		// Chapter 7 Programming project 16
		void flip();
		// ***************************************
