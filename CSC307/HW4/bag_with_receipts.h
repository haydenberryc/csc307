...
//  Postcondition: A new copy of item has been added the bag.
//
...
{
	template <class X> class bag_with_receipts
    { 
    public:
		...
		// overloaded << operator 
//		friend std::ostream& operator<<(std::ostream& os, const bag_with_receipts<X>& b);
...
#include "bag_with_receipts.template"
#endif
